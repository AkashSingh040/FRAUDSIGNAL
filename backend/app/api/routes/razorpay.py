        ...
        if payment_data:
            ...
            try:
                ...
                tx = NormalizedTransaction(
                    ...
                    timestamp=datetime.datetime.utcfromtimestamp(payment_data.get("created_at")).isoformat() if payment_data.get("created_at") else datetime.datetime.utcnow().isoformat(),
